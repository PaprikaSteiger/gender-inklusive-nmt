    ...
    if lemma.endswith("eau"):
        if "Gender=Masc" in morph:
            if "Number=Sing" in morph:
                ...
                noun._.value = f"elle{gender_token}au{gender_token}s".join(
                    text.rsplit("eaux", 1)
                )
        elif "Gender=Fem" in morph:
    ...
    if lemma.endswith("el"):
        if "Gender=Masc" in morph:
            if "Number=Sing" in morph:
                ...
                noun._.value = f"el{gender_token}le{gender_token}s".join(
                    text.rsplit("els", 1)
                )
        elif "Gender=Fem" in morph:
    ...
    if lemma.endswith("eur"):
        if "Gender=Masc" in morph:
            if "Number=Sing" in morph:
                ...
                noun._.value = f"eur{gender_token}rice{gender_token}s".join(
                    text.rsplit("rices", 1)
                )
                noun._.value = f"eur{gender_token}euse{gender_token}s".join(
                    text.rsplit("euses", 1)
                )
                noun._.value = f"eur{gender_token}e{gender_token}s".join(
                    text.rsplit("eures", 1)
                )
        elif "Gender=Fem" in morph:
            if text.endswith("eur") or text.endswith("eurs"):
                noun._.value = text
            elif text.endswith("rice") or text.endswith(
                "rices"
            ):  # teur/trice and deur/drice Noun
                if "Number=Sing" in morph:
                    noun._.value = f"eur{gender_token}rice".join(text.rsplit("rice", 1))
                elif "Number=Plur" in morph:
                    noun._.value = f"eur{gender_token}rice{gender_token}s".join(
    ...
    if lemma.endswith("oux"):
        if "Gender=Masc" in morph:
            if "Number=Sing" in morph:
                ...
                noun._.value = f"oux{gender_token}e{gender_token}s".join(
                    text.rsplit("oux", 1)
                )
        elif "Gender=Fem" in morph:
            if text.endswith("oux"):
                ...
                if "Number=Sing" in morph:
                    ...
                    noun._.value = f"oux{gender_token}se{gender_token}s".join(
                        text.rsplit("ousses", 1)
                    )
            elif text.endswith("ouce"):
                if "Number=Sing" in morph:
                    noun._.value = f"oux{gender_token}ce".join(text.rsplit("ouce", 1))
                elif "Number=Plur" in morph:
                    noun._.value = f"oux{gender_token}ce{gender_token}s".join(
                        text.rsplit("ouces", 1)
                    )
    ...
    if lemma.endswith("eux"):
        if "Gender=Masc" in morph:
            if "Number=Sing" in morph:
                ...
                noun._.value = f"eux{gender_token}e{gender_token}s".join(
                    text.rsplit("eux", 1)
                )
        elif "Gender=Fem" in morph:
    ...
    if lemma.endswith("s"):
        if "Gender=Masc" in morph:
            if "Number=Sing" in morph:
                ...
                noun._.value = f"{gender_token}xe{gender_token}s".join(
                    text.rsplit("s", 1)
                )
    ...
    if lemma.endswith("tre"):
        if "Gender=Masc" in morph:
            if "Number=Sing" in morph:
                ...
                noun._.value = f"tre{gender_token}xe{gender_token}s".join(
                    text.rsplit("tres", 1)
                )
        if "Gender=Fem" in morph:
    ...
    if lemma.endswith("en"):
        if "Gender=Masc" in morph:
            if "Number=Sing" in morph:
                ...
                noun._.value = f"en{gender_token}ne{gender_token}s".join(
                    text.rsplit("ens", 1)
                )
        if "Gender=Fem" in morph:
    ...
    if lemma.endswith("er"):
        if "Gender=Masc" in morph:
            if "Number=Sing" in morph:
                ...
                noun._.value = f"er{gender_token}ère{gender_token}s".join(
                    text.rsplit("ers", 1)
                )
        if "Gender=Fem" in morph:
    ...
    if lemma.endswith("t"):
        if "Gender=Masc" in morph:
            if "Number=Sing" in morph:
                ...
                noun._.value = f"t{gender_token}e{gender_token}s".join(
                    text.rsplit("ts", 1)
                )
        if "Gender=Fem" in morph:
    ...
    if lemma.endswith("nd"):
        if "Gender=Masc" in morph:
            if "Number=Sing" in morph:
                ...
                noun._.value = f"d{gender_token}e{gender_token}s".join(
                    text.rsplit("nds", 1)
                )
        if "Gender=Fem" in morph:
    ...
    if lemma.endswith("on"):
        if "Gender=Masc" in morph:
            if "Number=Sing" in morph:
                ...
                noun._.value = f"on{gender_token}ne{gender_token}".join(
                    text.rsplit("ons", 1)
                )
        elif "Gender=Fem" in morph:
            if text.endswith("on") or text.endswith("ons"):
                ...
                noun._.value = f"on{gender_token}ne{gender_token}s".join(
                    text.rsplit("onnes", 1)
                )
    ...
    if lemma.endswith("u"):
        if "Gender=Masc" in morph:
            if "Number=Sing" in morph:
                ...
                noun._.value = f"u{gender_token}e{gender_token}s".join(
                    text.rsplit("us", 1)
                )
        elif "Gender=Fem" in morph:
    ...
    if lemma.endswith("é"):
        if "Gender=Masc" in morph:
            if "Number=Sing" in morph:
                ...
                noun._.value = f"é{gender_token}e{gender_token}s".join(
                    text.rsplit("és", 1)
                )
        elif "Gender=Fem" in morph:
    ...
    if lemma.endswith("i"):
        if "Gender=Masc" in morph:
            if "Number=Sing" in morph:
                ...
                noun._.value = f"i{gender_token}e{gender_token}s".join(
                    text.rsplit("is", 1)
                )
        elif "Gender=Fem" in morph:
    ...
    if lemma.endswith("al"):
        if "Gender=Masc" in morph:
            if "Number=Sing" in morph:
                ...
                noun._.value = f"al{gender_token}e{gender_token}s".join(
                    text.rsplit("aux", 1)
                )
        elif "Gender=Fem" in morph:
    ...
    if lemma.endswith("ef"):
        if "Gender=Masc" in morph:
            if "Number=Sing" in morph:
                ...
                noun._.value = f"ef{gender_token}fe{gender_token}s".join(
                    text.rsplit("efs", 1)
                )
        elif "Gender=Fem" in morph:
    ...
    if lemma.endswith("tif"):
        if "Gender=Masc" in morph:
            if "Number=Sing" in morph:
                ...
                noun._.value = f"tif{gender_token}ive{gender_token}s".join(
                    text.rsplit("tifs", 1)
                )
        elif "Gender=Fem" in morph:
    ...
    if lemma.endswith("eau"):
        if "Gender=Masc" in morph:
            if "Number=Sing" in morph:
                ...
                adj._.value = f"elle{gender_token}au{gender_token}s".join(
                    text.rsplit("eaux", 1)
                )
        elif "Gender=Fem" in morph:
            if "Number=Sing" in morph:
    ...
    if lemma.endswith("el"):
        if "Gender=Masc" in morph:
            if "Number=Sing" in morph:
                ...
                adj._.value = f"el{gender_token}le{gender_token}s".join(
                    text.rsplit("els", 1)
                )
        elif "Gender=Fem" in morph:
            if "Number=Sing" in morph:
        ...
        if lemma.endswith("eur"):
            if "Gender=Masc" in morph:
                if "Number=Sing" in morph:
                    ...
                    adj._.value = f"eur{gender_token}rice{gender_token}s".join(
                        text.rsplit("rices", 1)
                    )
                    adj._.value = f"eur{gender_token}euse{gender_token}s".join(
                        text.rsplit("euses", 1)
                    )
                    adj._.value = f"eur{gender_token}e{gender_token}s".join(
                        text.rsplit("eures", 1)
                    )
            elif "Gender=Fem" in morph:
                if text.endswith("rice") or text.endswith(
                    "rices"
                ):  # teur/trice and deur/drice Noun
                    if "Number=Sing" in morph:
                        adj._.value = f"eur{gender_token}rice".join(
                            text.rsplit("rice", 1)
                        )
                    elif "Number=Plur" in morph:
                        adj._.value = f"eur{gender_token}rice{gender_token}s".join(
                    ...
                    if "Number=Sing" in morph:
                        adj._.value = f"eur{gender_token}euse".join(
                            text.rsplit("euse", 1)
                        )
                    elif "Number=Plur" in morph:
                        adj._.value = f"eur{gender_token}euse{gender_token}s".join(
        ...
        if lemma.endswith("oux"):
            if "Gender=Masc" in morph:
                if "Number=Sing" in morph:
                    ...
                    adj._.value = f"oux{gender_token}e{gender_token}s".join(
                        text.rsplit("oux", 1)
                    )
            elif "Gender=Fem" in morph:
                if text.endswith("ouse"):
                    ...
                    if "Number=Sing" in morph:
                        adj._.value = f"oux{gender_token}se".join(
                            text.rsplit("ousse", 1)
                        )
                    elif "Number=Plur" in morph:
                        adj._.value = f"oux{gender_token}se{gender_token}s".join(
                            text.rsplit("ousses", 1)
                        )
                elif text.endswith("ouce"):
                    if "Number=Sing" in morph:
                        adj._.value = f"oux{gender_token}ce".join(
                            text.rsplit("ouce", 1)
                        )
                    elif "Number=Plur" in morph:
                        adj._.value = f"oux{gender_token}ce{gender_token}s".join(
                            text.rsplit("ouces", 1)
                        )
        ...
        if lemma.endswith("eux"):
            if "Gender=Masc" in morph:
                if "Number=Sing" in morph:
                    ...
                    adj._.value = f"eux{gender_token}e{gender_token}s".join(
                        text.rsplit("eux", 1)
                    )
            elif "Gender=Fem" in morph:
                if "Number=Sing" in morph:
        ...
        if lemma.endswith("s"):
            if "Gender=Masc" in morph:
                if "Number=Sing" in morph:
                    ...
                    adj._.value = f"{gender_token}xe{gender_token}s".join(
                        text.rsplit("s", 1)
                    )
            if "Gender=Fem" in morph:
                if "Number=Sing" in morph:
        ...
        if lemma.endswith("tre"):
            if "Gender=Masc" in morph:
                if "Number=Sing" in morph:
                    ...
                    adj._.value = f"tre{gender_token}xe{gender_token}s".join(
                        text.rsplit("tres", 1)
                    )
            if "Gender=Fem" in morph:
                if "Number=Sing" in morph:
        ...
        if lemma.endswith("en"):
            if "Gender=Masc" in morph:
                if "Number=Sing" in morph:
                    ...
                    adj._.value = f"en{gender_token}ne{gender_token}s".join(
                        text.rsplit("ens", 1)
                    )
            if "Gender=Fem" in morph:
                if "Number=Sing" in morph:
        ...
        if lemma.endswith("er"):
            if "Gender=Masc" in morph:
                if "Number=Sing" in morph:
                    ...
                    adj._.value = f"er{gender_token}ère{gender_token}s".join(
                        text.rsplit("ers", 1)
                    )
            if "Gender=Fem" in morph:
                if "Number=Sing" in morph:
        ...
        if lemma.endswith("t"):
            if "Gender=Masc" in morph:
                if "Number=Sing" in morph:
                    ...
                    adj._.value = f"t{gender_token}e{gender_token}s".join(
                        text.rsplit("ts", 1)
                    )
            if "Gender=Fem" in morph:
                if "Number=Sing" in morph:
        ...
        if lemma.endswith("nd"):
            if "Gender=Masc" in morph:
                if "Number=Sing" in morph:
                    ...
                    adj._.value = f"d{gender_token}e{gender_token}s".join(
                        text.rsplit("nds", 1)
                    )
            if "Gender=Fem" in morph:
                if "Number=Sing" in morph:
        ...
        if lemma.endswith("on"):
            if "Gender=Masc" in morph:
                if "Number=Sing" in morph:
                    ...
                    adj._.value = f"on{gender_token}ne{gender_token}".join(
                        text.rsplit("ons", 1)
                    )
            elif "Gender=Fem" in morph:
                if "Number=Sing" in morph:
                    ...
                    adj._.value = f"on{gender_token}ne{gender_token}s".join(
                        text.rsplit("onnes", 1)
                    )
        ...
        if lemma.endswith("u"):
            if "Gender=Masc" in morph:
                if "Number=Sing" in morph:
                    ...
                    adj._.value = f"u{gender_token}e{gender_token}s".join(
                        text.rsplit("us", 1)
                    )
            elif "Gender=Fem" in morph:
                if "Number=Sing" in morph:
        ...
        if lemma.endswith("é"):
            if "Gender=Masc" in morph:
                if "Number=Sing" in morph:
                    ...
                    adj._.value = f"é{gender_token}e{gender_token}s".join(
                        text.rsplit("és", 1)
                    )
            elif "Gender=Fem" in morph:
                if "Number=Sing" in morph:
        ...
        if lemma.endswith("i"):
            if "Gender=Masc" in morph:
                if "Number=Sing" in morph:
                    ...
                    adj._.value = f"i{gender_token}e{gender_token}s".join(
                        text.rsplit("is", 1)
                    )
            elif "Gender=Fem" in morph:
                if "Number=Sing" in morph:
        ...
        if lemma.endswith("al"):
            if "Gender=Masc" in morph:
                if "Number=Sing" in morph:
                    ...
                    adj._.value = f"al{gender_token}e{gender_token}s".join(
                        text.rsplit("aux", 1)
                    )
            elif "Gender=Fem" in morph:
                if "Number=Sing" in morph:
        ...
        if lemma.endswith("ef"):
            if "Gender=Masc" in morph:
                if "Number=Sing" in morph:
                    ...
                    adj._.value = f"ef{gender_token}fe{gender_token}s".join(
                        text.rsplit("efs", 1)
                    )
            elif "Gender=Fem" in morph:
                if "Number=Sing" in morph:
